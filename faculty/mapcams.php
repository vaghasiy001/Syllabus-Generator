            ...
            <div id="wrapper">
                ...
                <div id="viewsubjects">
                    ...
                    <form method="post" name="form1" action="mapcams.php">
                        <table><tr><td><a href="modifycoursedetails.php<?php
                                    if (isset($_GET["semid"]) && isset($_GET["csid"])) {
                                        echo ("?semid=" . $_GET["semid"] . "&csid=" . $_GET["csid"]);
                                    }
                                    ?>">Go back to modify course details</a></td></tr></table>
                            <?php
