...
<?php include('header.html'); ?>
            ...
            <div id="wrapper">
                ...
                <?php } ?>
                <div id="viewsubjects">
                    <form method="post" action="selectohsem.php">			
                        <table border="1">
                            <?php
                            $data1 = ExecuteNonQuery('select semid,semname,active,year from semester order by sortorder');
                            ?>
                            <tr>
                                <td colspan="3" align="center">Select semester for Office Hours</td>
                            </tr>
                            <tr>
                            ...
                            <tr>
                                <td colspan="3" align="center"><input type="submit" value="Add Office Hours" name="submit"/></td>
                            </tr>
                        </table>
                    </form>
                </div>
