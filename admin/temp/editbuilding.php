...
if( isset($_POST['Submit']) )
 {   
		...
		if (empty($errors) ) 
		{
				...
				$str="update buildings set bname='".$_POST["buildingname"]."',active=$i where bid=".$_GET["id"];
		//		echo $str;
...
<div id="wrapper">        
    <div id="main">
      ...
      <div id="content">
			...
			<form method="post" action="editbuilding.php?id=<?php echo $_GET["id"];?>">
            	 <?php 
			...
			display_errors1($errors); 
                ...
                <tr>
                	<td>Building Name</td>
					<td>:</td>
                    <td><input type="text" name="buildingname" value="<?php echo $bname;?>"> </td>
                </tr>
                 <tr>
