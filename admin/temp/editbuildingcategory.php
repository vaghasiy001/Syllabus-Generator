 ...
 {   
		...
		if (empty($errors) ) 
		{
				...
				if($_POST["cbactive"]=="on")
					$i=1;
				$c_date = date("Y-m-d");
				$str="update buildingcategories set imgcatname='".$_POST["imgcatname"]."',active=b'".$i."',modifyip='".getip()."',modifydate='".$c_date."' where imgcatid=".$_GET["id"];
		//		echo $str;
...
<div id="wrapper">        
    <div id="main">
      ...
      <div id="content">
			...
			<form method="post" action="editbuildingcategory.php?id=<?php echo $_GET["id"];?>">
            	 <?php 
				$data = ExecuteNonQuery('select * FROM buildingcategories where imgcatid='.$_GET["id"]) or die(mysql_error());
