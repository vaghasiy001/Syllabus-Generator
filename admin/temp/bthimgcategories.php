...
<?php if($_GET["flag"]==1) { ?>
                ...
                <?php }?>
              <form method="post" action="bthimgcategories.php">
			<table style="margin-top:20px;">
            	   <tr>
                    ...
                    <select name="ddcatid">
                    <?php
							$data = ExecuteNonQuery('select * FROM bathcategories where active=1') or die(mysql_error());
