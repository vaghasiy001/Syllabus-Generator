...
<?php
 ...
 {
	 $_SESSION["icatid"]="blds";
	 $_SESSION["catid"]=$_POST["ddcatid"];

	redirect_to("bldimgsupload.php"); 
 }
 ?>
...
<?php if($_GET["flag"]==1) { ?>
                ...
                <?php }?>
              <form method="post" action="bldimgcategories.php">
			<table style="margin-top:20px;">
            	   <tr>
                    ...
                    <select name="ddcatid">
                    <?php
							$data = ExecuteNonQuery('select * FROM buildingcategories where active=1') or die(mysql_error());
