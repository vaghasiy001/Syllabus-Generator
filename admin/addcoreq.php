...
<?php if($_GET["flag"]==1) { ?>
            ...
            <div id="addbannerdiv">
            	<div id="info">
                	<p>This page allows you to add co requisite.<span style="float:right;"><a href="viewcoreqs.php"><img src="images/view.png" alt="view" width="50px"></a></p>
                </div>
           	<div id="contentdetail">
			<form method="post" action="addcoreq.php">
            ...
            <td colspan="3" >
                ...
                <tr>
					...
					<input type="text" value="<?php echo $_GET["name"];?>" size="50" name="txtcoreq"></td>
                </tr>
                <tr>
